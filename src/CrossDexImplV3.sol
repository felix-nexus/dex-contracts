...
contract CrossDexImplV3 is ICrossDexV3, UUPSUpgradeable, OwnableUpgradeable {
    ...
    address public override MAKER_VAULT_FACTORY; // immutable [v3] added
    ...
    function initialize(
        ...
        {
            // deploy maker vault factory
            MAKER_VAULT_FACTORY = _makerVaultFactory;
        }
    }

    function reinitialize(address _marketImpl, address _pairImpl, address _makerVaultFactory)
        external
        onlyOwner
        reinitializer(3)
    {
